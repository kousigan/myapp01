...
// module
exports.push([module.i, "/* You can add global styles to this file, and also import other style files */\n@font-face {\n  font-family: 'FontAwesome';\n  src: url(" + __webpack_require__(162) + ");\n  src: url(" + __webpack_require__(161) + "?#iefix&v=4.7.0) format('embedded-opentype'), \n  url(" + __webpack_require__(202) + ") format('woff2'), \n  url(" + __webpack_require__(203) + ") format('woff'), \n  url(" + __webpack_require__(201) + ") format('truetype'), \n  url(" + __webpack_require__(163) + "#fontawesomeregular) format('svg');\n  font-weight: normal;\n  font-style: normal;\n}\n\n\nbody{\n  margin: 0;\n  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif\n}", ""]);
